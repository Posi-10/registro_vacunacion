...
<div class="container">
  <div class="row justify-content-center align-items-center mt-4 pt-4">
    <div class="col-sm-4 align-self-center mt-4 pt-4">
      <form class="row g-3 p-2 border border-primary rounded-3" id="frm_login" name="frm_login" novalidate>
        <label for="login_correo" class="form-label ">Correo electronico</label>
        <div class="input-group mb-2">
          <span class="input-group-text rounded-end rounded-pill" id="addon-wrapping"><i class="fas fa-at"></i></span>
          <input type="email" class="form-control rounded-start rounded-pill" id="login_correo" name="login_correo" required>
          <div class="invalid-feedback">
            Falta que coloques tu Correo electronico ó Tu Correo debe de ser gmail, hotmail, live, outlook
          </div>
        </div>
        <label for="login_pass" class="form-label">Contraseña</label>
        <div class="input-group mb-2">
          <span class="input-group-text rounded-end rounded-pill" id="addon-wrapping"><i class="fas fa-key"></i></span>
          <input type="password" class="form-control rounded-start rounded-pill" id="login_pass" name="login_pass" required>
        </div>
        <div class="text-end">
          <a href="registro" class="link-secondary">Registro</a>
        </div>
        <span class="btn btn-primary rounded-pill" id="btn_login" name="btn_login" >Entrar</span>
      </form>
    </div>
  </div>
</div>
